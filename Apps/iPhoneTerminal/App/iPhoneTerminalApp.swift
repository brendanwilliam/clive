...
final class IPhoneTerminalAppDelegate: NSObject, UIApplicationDelegate {
...
struct iPhoneTerminalApp: App {
    @UIApplicationDelegateAdaptor(IPhoneTerminalAppDelegate.self) private var appDelegate
