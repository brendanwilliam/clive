...
actor IPhoneRendezvousService {
    ...
    init() throws {
        let identifier = Bundle.main.object(forInfoDictionaryKey: "IPhoneTerminalCloudContainer") as? String ?? "iCloud.com.iphoneterminal"
        cloud = CloudRendezvousStore(containerIdentifier: identifier)
        keys = try RendezvousKeyStore(service: "com.iphoneterminal.iphone.rendezvous").loadOrCreate()
    }
